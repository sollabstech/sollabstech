                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${result.stickerColor}30`,
                        background: `linear-gradient(135deg, rgba(10,22,40,0.8), ${result.stickerColor}08)`,
                      }}
                    >
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
                        ...
                        <div style={{
                          ...
                          background: `linear-gradient(135deg, ${result.stickerColor}, #00AAFF)`,
                          display: "flex", alignItems: "center", justifyContent: "center",
                          fontWeight: 800, fontSize: 24, color: "white",
                          boxShadow: `0 8px 24px ${result.stickerColor}50`,
                          position: "relative",
                        }}>
                          ...
                          <div style={{
                            ...
                            background: "#4ADE80", border: "2px solid #050A18",
                          }} />
                        </div>
                        {/* Name + city */}
                        <div>
                    ...
                    <div className="glass" style={{ borderRadius: 18, padding: "24px", border: "1px solid rgba(255,255,255,0.07)" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
                        <div style={{
                          ...
                          background: `${result.stickerColor}15`,
                          border: `1px solid ${result.stickerColor}30`,
                          display: "flex", alignItems: "center", justifyContent: "center",
                      ...
                      <div style={{
                        ...
                        fontSize: 12, color: "#6B7A94", lineHeight: 1.6,
                      }}>
                        {result.specs}
                      </div>
                    </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div className="glass" style={{ borderRadius: 18, padding: "28px", border: "1px solid rgba(255,255,255,0.07)" }}>
                      ...
                      <div style={{ textAlign: "center", marginBottom: 24 }}>
                        <div style={{
                          ...
                          background: status.isExpired
                            ? "#F87171"
                            : status.isExpiringSoon
                            ? "linear-gradient(135deg, #FDE047, #F59E0B)"
                            : `linear-gradient(135deg, ${result.stickerColor}, #00AAFF)`,
                        ...
                        {!status.isExpired && (
                          <div style={{ fontSize: 12, color: "#3D4F6B", marginTop: 2 }}>
                        ...
                        <div style={{ height: 10, borderRadius: 100, background: "rgba(255,255,255,0.06)", overflow: "hidden" }}>
                          <div style={{
                            ...
                            background: status.isExpired
                              ...
                              : `linear-gradient(90deg, ${result.stickerColor}, #00AAFF)`,
                            transition: "width 1s ease",
                            boxShadow: `0 0 10px ${result.stickerColor}60`,
                          }} />
                        </div>
                        ...
                        {Array.from({ length: result.warrantyMonths }).map((_, i) => {
                          ...
                          return (
                            <div key={i} style={{
                              ...
                              background: isUsed ? "rgba(255,255,255,0.08)" : isCurrent ? result.stickerColor : `${result.stickerColor}20`,
                              border: `1px solid ${isUsed ? "rgba(255,255,255,0.05)" : isCurrent ? result.stickerColor : `${result.stickerColor}40`}`,
                              display: "flex", alignItems: "center", justifyContent: "center",
                              fontSize: 9, color: isUsed ? "#3D4F6B" : isCurrent ? "white" : "#00AAFF",
                              fontWeight: 600,
                              boxShadow: isCurrent ? `0 0 10px ${result.stickerColor}80` : "none",
                            }}>
                              {i + 1}
                            </div>
                          );
                      ...
                      <div style={{ marginTop: 20, textAlign: "center" }}>
                        <div style={{
                          ...
                          background: status.isExpired ? "rgba(239,68,68,0.1)" : "rgba(34,197,94,0.1)",
                          border: `1px solid ${status.isExpired ? "rgba(239,68,68,0.3)" : "rgba(34,197,94,0.3)"}`,
                        }}>
                    ...
                    <div className="glass" style={{ borderRadius: 18, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)" }}>
                      ...
                      <div style={{ position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden" }}>
                        <iframe
                          src={`https://www.youtube.com/embed/${result.saleVideoId}?rel=0&modestbranding=1`}
                          title="Laptop Sale Video"
