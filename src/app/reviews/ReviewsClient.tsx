      ...
      <section style={{ padding: "0 24px 100px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 20 }}>
            {filtered.map((review) => (
              <div key={review.id} className="glass card-hover" style={{ borderRadius: 16, padding: "28px", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                  ...
                  <span style={{ padding: "3px 10px", borderRadius: 100, fontSize: 10, fontWeight: 600, background: review.type === "software" ? "rgba(0,102,255,0.15)" : "rgba(0,170,255,0.1)", border: `1px solid ${review.type === "software" ? "rgba(0,102,255,0.3)" : "rgba(0,170,255,0.2)"}`, color: "#00AAFF" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ width: 46, height: 46, borderRadius: "50%", background: "linear-gradient(135deg, #0066FF, #00AAFF)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 14, color: "white", flexShrink: 0 }}>{review.avatar}</div>
                  <div>
