    ...
    <>
      ...
      <section className="track-hero" style={{ paddingTop: 120, paddingBottom: 60, paddingLeft: 24, paddingRight: 24, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 680, margin: "0 auto" }}>
          ...
          {/* Search box */}
          <div className="track-search" style={{
            ...
            <button
              ...
              style={{ padding: "10px 24px", fontSize: 14, borderRadius: 10, opacity: loading || !projectId.trim() ? 0.6 : 1 }}
            >
              {loading ? (
            ...
            {!result && (
              <div style={{
                ...
                <p style={{ color: "#6B7A94", fontSize: 15 }}>
                  No project found for ID <strong style={{ color: "#F87171" }}>{projectId}</strong>.
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: `${result.accentColor}15`,
                    border: `1px solid ${result.accentColor}40`,
                    fontSize: 13, fontWeight: 700, color: result.accentColor,
                  }}>
                    {result.typeEmoji} {result.projectType}
                  </div>
                </div>
                        ...
                        <div key={stage} style={{ display: "flex", alignItems: "center", flex: 1 }}>
                          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, flex: 1 }}>
                            <div style={{
                              ...
                              background: done ? cfg.color : current ? `${cfg.color}20` : "rgba(255,255,255,0.05)",
                              border: `2px solid ${done || current ? cfg.color : "rgba(255,255,255,0.08)"}`,
                              display: "flex", alignItems: "center", justifyContent: "center",
                              fontSize: 16,
                              boxShadow: current ? `0 0 16px ${cfg.color}60` : "none",
                            }}>
                              {done ? "✓" : cfg.emoji}
                            </div>
                            <div style={{ fontSize: 11, color: done || current ? cfg.color : "#3D4F6B", fontWeight: done || current ? 700 : 400, textAlign: "center" }}>
                              {cfg.label.replace(" ✓", "")}
                            </div>
                          </div>
                          {idx < STAGES.length - 1 && (
                            <div style={{
                              ...
                              background: idx < stageIndex ? STATUS_CONFIG[STAGES[idx + 1]].color : "rgba(255,255,255,0.06)",
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: `linear-gradient(135deg, rgba(10,22,40,0.8), ${result.accentColor}08)`,
                      }}
                    >
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
                        ...
                        <div style={{
                          ...
                          background: `linear-gradient(135deg, ${result.accentColor}, #00AAFF)`,
                          display: "flex", alignItems: "center", justifyContent: "center",
                          fontWeight: 800, fontSize: 24, color: "white",
                          boxShadow: `0 8px 24px ${result.accentColor}50`,
                          position: "relative",
                        }}>
                          ...
                          <div style={{
                            ...
                            background: result.status === "delivered" ? "#4ADE80" : result.accentColor,
                        ...
                        {result.features.map((feature) => (
                          <div key={feature} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            <div style={{
                              ...
                              display: "flex", alignItems: "center", justifyContent: "center",
                              fontSize: 10, color: result.accentColor, fontWeight: 700,
                            }}>
                              ✓
                            </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div className="glass" style={{ borderRadius: 18, padding: "28px", border: "1px solid rgba(255,255,255,0.07)" }}>
                      ...
                      <div style={{ marginBottom: 20 }}>
                        <div style={{ height: 12, borderRadius: 100, background: "rgba(255,255,255,0.06)", overflow: "hidden" }}>
                          <div style={{
                            ...
                            borderRadius: 100,
                            background: `linear-gradient(90deg, ${result.accentColor}, #00AAFF)`,
                            transition: "width 1.2s ease",
                            boxShadow: `0 0 12px ${result.accentColor}60`,
                          }} />
                        </div>
                      ...
                      <div style={{
                        ...
                        background: `${result.accentColor}08`,
                        border: `1px solid ${result.accentColor}20`,
                      }}>
                    ...
                    <div className="glass" style={{ borderRadius: 18, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)" }}>
                      <div style={{ padding: "16px 20px 12px", fontSize: 11, color: "#3D4F6B", fontWeight: 600, letterSpacing: 1, textTransform: "uppercase" }}>
                        📹 Project Demo
                      </div>
                      <div style={{ position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden" }}>
                        <iframe
                          src={`https://www.youtube.com/embed/${result.demoVideoId}?rel=0&modestbranding=1`}
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", gap: 10 }}>
                    ...
                    <a href="mailto:sollabstech@gmail.com" className="btn-outline" style={{ fontSize: 13, padding: "9px 20px" }}>
                      📧 Email
                    </a>
                  </div>
                </div>
      ...
      {/* ── What we build (shown before search) ── */}
      {!searched && (
        <section style={{ padding: "0 24px 100px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <h2 style={{ textAlign: "center", fontSize: 18, fontWeight: 700, color: "white", marginBottom: 12 }}>
              We Build <span className="gradient-text-blue">Everything Digital</span>
            </h2>
            <p style={{ textAlign: "center", color: "#6B7A94", fontSize: 14, marginBottom: 36 }}>
              Enter your Project ID above to track your custom software&apos;s live status
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 16 }} className="what-grid">
              {[
                ...
                <div key={item.title} className="glass card-hover" style={{
                  borderRadius: 16, padding: "28px 24px",
                  border: `1px solid ${item.color}20`,
                  background: `linear-gradient(135deg, rgba(10,22,40,0.8), ${item.color}06)`,
                }}>
                  <div style={{
